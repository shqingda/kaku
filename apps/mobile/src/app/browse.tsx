...
const styles = StyleSheet.create({
  ...
  filterCard: { alignItems: 'center', backgroundColor: COLORS.surface, borderRadius: 18, flexDirection: 'row', marginTop: 14, paddingLeft: 13 },
  filterInput: { color: COLORS.ink, flex: 1, fontSize: 13, height: 48, paddingHorizontal: 7 },
  filterDivider: { backgroundColor: COLORS.track, height: 24, width: StyleSheet.hairlineWidth },
  applyButton: { backgroundColor: COLORS.ink, borderRadius: 13, marginRight: 5, paddingHorizontal: 14, paddingVertical: 10 },
