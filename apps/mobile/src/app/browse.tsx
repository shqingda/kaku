...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  sort: { alignItems: 'center', backgroundColor: colors.surface, borderRadius: 12, justifyContent: 'center', minHeight: 34, paddingHorizontal: 14 },
  ...
  applyButton: { alignItems: 'center', backgroundColor: colors.ink, borderRadius: 12, height: 34, justifyContent: 'center', paddingHorizontal: 14 },
