  ...
  return (
    <section className="support-page section-pad">
      ...
      <div className="support-grid">
        ...
        <article><span>02</span><h2>问题反馈</h2><p>请附上设备型号、系统版本和复现步骤。不要在公开内容中提交 access token、Session 或其他私密凭据。</p><a href="https://github.com/shqingda/kaku/issues/new" rel="noreferrer" target="_blank">提交问题 <span aria-hidden="true">→</span><span className="visually-hidden">（在新窗口打开）</span></a></article>
